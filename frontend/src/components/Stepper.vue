    ...
    <v-stepper v-model="e1">
      ...
      <v-stepper-items>
        <v-stepper-content step="1">
          <v-card class="mb-6" color="grey lighten-1" height="300px"></v-card>
          <p>🌍 원하는 언어를 선택해주세요</p>
          <div class="d-flex">
            <v-spacer></v-spacer>
        ...
        <v-stepper-content step="2">
          ...
          <div class="d-flex">
            <v-spacer></v-spacer>
            <v-btn outlined color="indigo" @click="e1 = 3"> 다음 </v-btn>
          </div>
        </v-stepper-content>
        ...
        <v-stepper-content step="3">
          ...
          <div class="d-flex">
            <v-spacer></v-spacer>
            <v-btn outlined color="indigo" @click="e1 = 4"> 다음 </v-btn>
          </div>
        </v-stepper-content>
