  ...
  <div class="category-cards">
    <div class="perspective">
      <div class="animal-card-container" @click="startGame(1)">
        ...
        <div class="card animal-card-card3">
          <div class="card__face card__face--top">
            <span class="card__value"> Fruit </span>
          </div>
          <div class="card__face card__face--btm">
            <span class="card__value"> Fruit </span>
            <span class="card__suit">
      ...
      <div class="fruit-card-container">
        ...
        <div class="card fruit-card-card3">
          <div class="card__face card__face--top">
            <span class="card__value"> Fruit </span>
          </div>
          <div class="card__face card__face--btm">
...
.animal-card-container {
  ...
  max-width: 320px;
  .card-card1 {
    transform: rotate(-17deg) translate3d(-23%, -5%, 0);
    box-shadow: 0 1px 2px 0 rgba(151, 150, 146, 0.4),
      0 2px 6px 0 rgba(151, 150, 146, 0.4) W;
  }
  .card-card2 {
    transform: rotate(-10deg) translate3d(-10%, -8%, 0);
    box-shadow: 0 1px 2px 0 rgba(151, 150, 146, 0.4),
      0 2px 4px 0 rgba(151, 150, 146, 0.4);
  }
  .animal-card-card3 {
    transform: rotate(0deg) translate3d(0%, -8%, 0);
    box-shadow: 0 1px 2px 0 rgba(151, 150, 146, 0.4),
      0 2px 4px 0 rgba(151, 150, 146, 0.4);
  }
}
